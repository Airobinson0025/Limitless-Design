...
const About = () => {
    ...
    <div className='flex flex-col items-center justify-evenly h-full bg-fixed bg-center bg-cover custom-img'>
        ...
        initial='hidden' animate='visible' variants={{
            ...
            <h1 className='font-vibes font-bold text-[3.7rem] sm:text-[4.5rem] text-left pl-6 text-[#A24857] tracking-[3px] border-l-4 border-[#A24857] pt-4 mb-8 ml-6'>About Us</h1>
