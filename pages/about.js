...
const About = () => {
    ...
    <div className='flex flex-col items-center justify-evenly h-full bg-fixed bg-center bg-cover custom-img'>
        ...
        initial='hidden' animate='visible' variants={{
            ...
            <h1 className='font-vibes font-bold text-[3.7rem] sm:text-[4.5rem] text-center text-[#A24857] tracking-[3px] pt-4 mb-8 '>About Us</h1>
            ...
            <div className='text-stone-900 text-[1.3rem] sm:text-[1.4rem] space-y-5  sm:border-neutral-600 p-6'>
                ...
                <div className=''>
                    ...
                    <div className='flex flex-col sm:flex-row sm:justify-between sm:items-center space-y-6 mt-12'>
                       <p className='font-vibes font-bold text-[2.4rem] text-[#A24857] text-center tracking-[2px]'>Limitless Design</p>
                       <motion.button
                        onClick={() => {
                            router.push('/contact')
                        }}
